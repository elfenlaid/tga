...
module.exports = eleventyConfig => {
  ...
  eleventyConfig.addPairedShortcode("callout", function (content, level = "info", format = "html") {
    ...
    function icon() {
      switch (level) {
        case "info":
          return '<svg class="w-6 h-6 stroke-current text-light-blue-600 dark:text-light-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>'
        case "warn":
